...
// PG_ACCELEROMETER_CONFIG
    ...
    { PARAM_NAME_ACC_INFLIGHT_CAL_GYRO_LIMIT, VAR_UINT8 | MASTER_VALUE, .config.minmaxUnsigned = { 5, 100 }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, acc_inflight_cal_gyro_limit) },

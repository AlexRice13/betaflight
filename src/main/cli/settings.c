...
// PG_ACCELEROMETER_CONFIG
    ...
    { PARAM_NAME_ACC_INFLIGHT_CAL_LPF_HZ, VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 500 }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, acc_inflight_cal_lpf_hz) },

...
// PG_ACCELEROMETER_CONFIG
    ...
    { PARAM_NAME_INFLIGHT_ACC_CAL_WINDOW, VAR_UINT8 | MASTER_VALUE, .config.minmaxUnsigned = { 10, 200 }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, inflight_acc_cal_window) },

...
// PG_ACCELEROMETER_CONFIG
    ...
    { PARAM_NAME_ACC_INFLIGHT_CAL_SAMPLES, VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 50, 500 }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, acc_inflight_cal_samples) },
    { PARAM_NAME_ACC_INFLIGHT_CAL_GYRO_LIMIT, VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 5, 600 }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, acc_inflight_cal_gyro_limit) },
    { PARAM_NAME_ACC_INFLIGHT_CAL_APPLY_1G, VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, acc_inflight_cal_apply_1g) },

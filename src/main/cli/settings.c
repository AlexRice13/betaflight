...
// PG_ACCELEROMETER_CONFIG
    ...
    { "acc_calibration_cycles",     VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 50, 1000 }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, acc_calibration_cycles) },
    { "acc_inflight_calibration_cycles", VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 10, 200 }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, acc_inflight_calibration_cycles) },
